            ...
            modelBuilder.Entity("MedicalEquipmentMarket.Model.PickupSchedule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanId = 1,
                            EquipId = 1,
                            ScheduleTime = new DateTime(2023, 11, 19, 19, 1, 15, 511, DateTimeKind.Utc).AddTicks(682),
                            Status = "zakazan"
                        });
                });
            ...
            modelBuilder.Entity("MedicalEquipmentMarket.Model.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompId = 2,
                            EquipmId = 2,
                            ReservationTime = new DateTime(2023, 11, 19, 19, 1, 15, 511, DateTimeKind.Utc).AddTicks(641)
                        });
                });
