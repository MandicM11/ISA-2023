    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 1, new DateTime(2023, 11, 19, 19, 1, 15, 511, DateTimeKind.Utc).AddTicks(682), "zakazan" });

            migrationBuilder.InsertData(
                table: "Reservation",
                columns: new[] { "ReservationId", "BuyerAccountId", "CompId", "EquipmId", "ReservationTime" },
                values: new object[] { 1, 1, 2, 2, new DateTime(2023, 11, 19, 19, 1, 15, 511, DateTimeKind.Utc).AddTicks(641) });
        }
